...
ipcMain.on('uploadFW', (e, args) => {
  ...
  var execArgs = ['-v', '-pm2560', '-C', configName, '-carduino', '-b 115200', '-D', '-P', args.port, '-D', '-U', hexFile];
  var execArgs_old = ['-v', '-pm2560', '-C', configName, '-carduino', '-b 57600', '-D', '-P', args.port, '-D', '-U', hexFile];
